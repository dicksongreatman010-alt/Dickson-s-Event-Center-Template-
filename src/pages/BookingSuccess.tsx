        ...
        >
          {type === 'payment_verifying' ? (
            <>
              ...
              <h2 className="text-3xl font-bold text-burgundy mb-4">Payment Verification Sent!</h2>
              <p className="text-text-gray mb-8 leading-relaxed">
                Thank you! We've notified the admin to verify your deposit. Once verified, your booking will be confirmed and you will receive a receipt via email or WhatsApp shortly.
              </p>
            </>
          ) : (
            <>
              ...
              <h2 className="text-3xl font-bold text-burgundy mb-4">Booking Confirmed!</h2>
              <p className="text-text-gray mb-8 leading-relaxed">
